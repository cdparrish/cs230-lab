...
<html>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="">
            <a class="navbar-brand" href="../cs230-lab/gallery.php">Milky Market</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    if(isset($_SESSION['uid'])){
                        ...
                        <a class="nav-link" href="/cs230-lab/includes/logout.php">Logout</a>
                    </li>';
                    }
                    else{
                        echo '<li class="nav-item">
                        <a class="nav-link" href="/cs230-lab/login.php">Login</a>
                    </li>';
                    }
                    ?>
                </ul>
